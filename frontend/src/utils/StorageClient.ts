...
// NOTE: The original project used Caffeine's icp-sdk helpers.
// To keep this frontend buildable on standard npm/CDNs, we provide a tiny compatibility shim.
function isV3ResponseBody(_body: unknown): boolean { return true; }
