...
export async function loadConfig(): Promise<Config> {
    ...
    const backendCanisterId = (import.meta as any).env?.VITE_CANISTER_ID_BACKEND ?? (import.meta as any).env?.CANISTER_ID_BACKEND;
    const envBaseUrl = (import.meta as any).env?.BASE_URL || (import.meta as any).env?.VITE_BASE_URL || '/';
